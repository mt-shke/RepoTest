...
<div class="container py-5" style="max-width: 620px;">
    ...
    <div class="detail-card">
        ...
        <div class="detail-card-header">
            <div>
                <div class="task-title-main">Préparer la présentation</div>
                <span class="cat-chip">💼 Professionnelle</span>
            </div>
            <span class="badge badge-going rounded-pill px-3 py-2">🔵 En cours</span>
        </div>
        ...
        <div class="detail-body">
            ...
            <div class="field-row">
                ...
                <div>
                    ...
                    <div class="field-value">Créer les diapositives pour la réunion client du 20 février. Inclure les KPIs du trimestre et les projections pour le prochain semestre.</div>
                </div>
            </div>
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="dates-row mt-2">
                        <div class="date-block">
                            ...
                            <div class="date-value">16/02/2026</div>
                        </div>
                        <div class="date-block">
                            <div class="date-label">Date de fin</div>
                            <div class="date-value" style="color:var(--cyan);">20/02/2026</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="field-row">
                ...
                <div>
                    ...
                    <div class="mt-2 d-flex gap-2">
                        <span class="badge badge-todo rounded-pill px-3 py-2">⭕ Pas commencé</span>
                        <span class="badge badge-going rounded-pill px-3 py-2">🔵 En cours</span>
                        <span class="badge badge-done rounded-pill px-3 py-2">✅ Terminé</span>
                    </div>
                </div>
            </div>
